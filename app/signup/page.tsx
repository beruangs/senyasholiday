            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white rounded-[3.5rem] p-12 border border-gray-100 shadow-2xl animate-in zoom-in-95 duration-500">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <InputBox label={t.auth.full_name} val={formData.name} setVal={(v: any) => setFormData({ ...formData, name: v })} icon={<User className="w-4 h-4" />} placeholder="FULL NAME" />
                        ...
                        <InputBox label={t.auth.password} val={formData.password} setVal={(v: any) => setFormData({ ...formData, password: v })} icon={<Lock className="w-4 h-4" />} placeholder="••••••••" type="password" />
                        <InputBox label={t.auth.confirm_password} val={formData.confirmPassword} setVal={(v: any) => setFormData({ ...formData, confirmPassword: v })} icon={<Lock className="w-4 h-4" />} placeholder="••••••••" type="password" error={formData.confirmPassword && formData.password !== formData.confirmPassword} />
