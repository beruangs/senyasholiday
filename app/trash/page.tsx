...
export default function TrashPage() {
    ...
    const restorePlan = async (planId: string) => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success('Plan berhasil di-restore!')
                fetchTrash()
            } else {
                const data = await res.json()
    ...
    const permanentDelete = async (planId: string, title: string) => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success('Plan berhasil dihapus permanen')
                fetchTrash()
            } else {
                const data = await res.json()
                            ...
                            >
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            onClick={() => permanentDelete(plan._id, plan.title)}
                                            disabled={actionLoading === plan._id}
