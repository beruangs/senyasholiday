...
export default function SuggestionButton({ page = 'Unknown' }: { page?: string }) {
  ...
  return (
    <>
      <button onClick={() => setIsOpen(true)} className="fixed bottom-10 right-10 z-[500] p-5 bg-primary-600 text-white rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all group border-4 border-white"><Lightbulb className="w-6 h-6 group-hover:rotate-12 transition-transform" /></button>
